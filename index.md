...
venue: "Quarterly SI Data Carpentry: Fall 2019 Edition"        # brief name of host site without address (e.g., "Euphoric State University")
...
latitude: "38.888778"     # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-77.025991"    # decimal longitude of the workshop venue (use https://www.latlong.net)
...
instructor: ["Amanda Devine","Matthew Kweskin","Alex Robillard", "Luis Villanueva"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jen Hammock", "Mike Trizna"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://github.com/SmithsonianWorkshops/2019-11-21-castle            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 79583669899          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p id="collaborative_notes">
  We will use this <a href="{{page.collaborative_notes}}">collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code. <br />
  <a href="{{page.collaborative_notes}}">{{page.collaborative_notes}}</a>
</p>
{% endif %}
